...
const projects = [
  {
    ...
    description: "A comprehensive e-commerce platform allowing users to browse, add tickets to cart, and make secure purchases with organizer and admin functionality.",
    techStack: ["PHP", "Tailwind CSS", "SQL", "javascript"],
    liveLink: "https://preview-ticketking.vercel.app/",
    codeLink: "https://github.com/tasmim-tahsin/Event_Ticketing_Platform",
    imagePath: "/ticketking.png"
  }
  ,
  {
    id: 12,
    title: "Air Quality Index - AQI website",
    description: "A AQI checking website. Where user can register and login to the system to view AQI of selected cities. With edit profile and Admin login facilities.",
    techStack: ["HTML","CSS", "PHP", "SQL", "javascript"],
    liveLink: "https://aqi.free.nf/index.php",
    codeLink: "https://github.com/tasmim-tahsin/web_tech",
    imagePath: "/ticketking.png"
  }
  ,
  {
    id: 13,
    title: "SuperShop Management System - Desktop App",
    description: "A desktop app for seamless shop management with product CRUD facilities with 3 type of user. MySQL databse used for storing users and products data.",
    techStack: ["C#",".NET", "WinForms", "MS SQL", "GUI"],
    liveLink: "#",
    codeLink: "https://github.com/tasmim-tahsin/SuperShopManagementSystemWindowsApplication",
    imagePath: "/ticketking.png"
  }
  ,
  ...
  {
    id: 14,
    title: "AIUB Sports Complex Managemnt - GUI Application ",
    description: "A Java based GUI application for AIUB sports complex managemts. Where user can book slot based on availability. Admin can manage slots for their complex.",
    techStack: ["Java", "Swing", "GUI"],
    liveLink: "#",
    codeLink: "https://github.com/tasmim-tahsin/AIUB-SportsComplex-java",
    imagePath: "/ticketking.png"
  }
  ,
  {
...
const techIcons = {
  ...
  "CoinGecko API": "https://static.coingecko.com/s/coingecko-logo-8903d34ce19ca4be1c81f0db30e924154750d703683c7c872d10a077caabcfae.png",
  ...
  "OpenWeather API": "https://openweathermap.org/themes/openweathermap/assets/img/logo_white_cropped.png",
  ...
  "TMDB API": "https://www.themoviedb.org/assets/2/v4/logos/v2/blue_square_2-d537fb228cf3ded904ef09b136fe3fec72548ebc1fea3fbbd1ad9e36364db38b.svg",
  ...
  "MS SQL": "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/microsoftsqlserver/microsoftsqlserver-plain-wordmark.svg",
  "Java": "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original-wordmark.svg",
  "C#": "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/csharp/csharp-original.svg",
  ".NET": "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/dot-net/dot-net-original-wordmark.svg",
  "ASP.NET": "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/dotnetcore/dotnetcore-original.svg",
  
  // GUI/Frontend
  "GUI": "https://cdn-icons-png.flaticon.com/512/1087/1087840.png", // Generic GUI icon
  "WPF": "https://upload.wikimedia.org/wikipedia/commons/5/5c/Microsoft_.NET_logo.png",
  "WinForms": "https://cdn-icons-png.flaticon.com/512/6132/6132222.png",
  "Swing": "https://cdn-icons-png.flaticon.com/512/226/226777.png", // Java icon
  "JavaFX": "https://cdn-icons-png.flaticon.com/512/226/226777.png" // Java icon
};
            ...
            <div className=' grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-5 justify-center items-center py-10 '>
              {
                projects.slice(0,dataLength).map( (project) =>
                  <div key={project.id} className=' p-5 '>
                        <div className="card-bordered text-white dark:text-[#151C25] shadow-xl w-96 h-auto rounded-badge flex flex-col justify-center items-center">
                              <figure>
                                <Image
                                  ...
                                  className=' rounded-t-badge h-40'
                              ...
                              <div className="card-body max-h-96">
                                ...
                                <div className="card-actions flex flex-col justify-start mt-5">
                                  <div className=" font-semibold">Technology used</div>
                                  <div className=' flex justify-start gap-[10] mt-2 bg-white p-2 rounded-full'>
                                    {project.techStack.map((tech, index) => (
  <img
    key={index}
    src={techIcons[tech] || "https://via.placeholder.com/30"}
    alt={tech}
    width={30}
    height={30}
    title={tech}
